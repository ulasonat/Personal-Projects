...
public class ServiceField extends Field {
    ...
    // The naming on Service fields will work like it does on Lucky fields.
    // Service fields won't have names as property fields have, instead they will have ID numbers, so the names of the
    // Service fields will be like Service Field 1, Service Field 2 etc.
     ...
     * @param amount Determines how much money the players will pay when they get to this field.
     */
    public ServiceField(int amount) {
        super(("Service Field " + Integer.toString(ID++)), amount); // The ID will be incremented after passing its value to the name.
    }
